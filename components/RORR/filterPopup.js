        ...
        <View>
            <Menu>
                ...
                <MenuOptions customStyles={{
                    ...
                    <MenuOption style={[Styles.icon,{margin: 4}]} onSelect={() => {props.navigation.navigate("RORRItemSearch")}}>
                    ...
                    <MenuOption style={[Styles.icon,{margin: 4}]} onSelect={() => { props.setShowType("special"); props.setFilterText("Special")}}>
                        <Text style={[Styles.RORText,{color: itemColors["void"]}]}>Special</Text>
                    </MenuOption>
